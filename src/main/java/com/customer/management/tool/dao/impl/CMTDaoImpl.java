...
public class CMTDaoImpl implements CMTDao {
    ...
    public boolean isExist(Customer customer) {
        ...
        args.add(customer.getEmail());
        args.add(customer.getMobile());
        List<Customer> response = jdbcTemplate.query(CMTQueryConstant.ISEXIST, new CMTExtractor(), args.toArray());
    ...
    public List<Customer> getCustomer(Customer customer) {
        ...
        List<Customer> response = jdbcTemplate.query(query.toString(), new CMTExtractor(), args.toArray());
    ...
    public Customer getCustomerId(Customer customer) {
        ...
        if (!StringUtils.isEmpty(customer) && !StringUtils.isEmpty(customer.getEmail())) {
            ...
            List<String> args = new ArrayList<>();
            args.add(customer.getEmail());
            List<Customer> customerList = jdbcTemplate.query(query, new CMTExtractor(), args.toArray());
    ...
    public List<CustomerReparingDetail> findRepairDetailsByCustomerId(CustomerReparingDetail reparingDetail) {
        ...
        if (!StringUtils.isEmpty(reparingDetail) && !StringUtils.isEmpty(reparingDetail.getCustomerId())) {
            ...
            List<CustomerReparingDetail> reparingDetailList = jdbcTemplate.query(query, new CustomerRepairingDetailExtractor(),
                    args.toArray());
            System.out.println(System.currentTimeMillis());
