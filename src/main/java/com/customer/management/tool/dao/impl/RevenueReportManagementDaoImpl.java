...
import com.customer.management.tool.dao.RevenueReportDao;
...
@Component
public class RevenueReportManagementDaoImpl implements RevenueReportDao {
	...
	public List<CustomerJobDetail> startToEndDate(ReportGenerator reportGenerator) {
		...
		List<CustomerJobDetail> listResult = jdbcTemplate.query(query, new JobExtractor(),
				args.toArray());
		return listResult;
	}
