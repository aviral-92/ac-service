...
public class JobListByDate extends CMTServiceImpl {
    ...
    private void initComponents() {
        ...
        underConstruction = new javax.swing.JRadioButton();
        ...
        buttonGroup1.add(underConstruction);
        underConstruction.setText("Under Process");

        jLabel3.setText("Choose work");

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Any one of this when searching Under Process", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
	...
	private void SearchActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_SearchActionPerformed
		...
		List<CustomerJobDetail> customerJobDetails = cmtImpl.searchByDate(
				startDate.getDate(), endDate.getDate(), isPending);
		if (!StringUtils.isEmpty(customerJobDetails)
				&& !customerJobDetails.isEmpty()) {
			display(customerJobDetails);
		} else {
			JOptionPane.showMessageDialog(new JFrame(),
					"No jobs in between dates", "Error",
	...
	public void display(List<CustomerJobDetail> customerJobDetails) {
		...
		for (CustomerJobDetail customerJobDetail : customerJobDetails) {
			...
			model.addRow(new Object[] {
					...
					customerJobDetail.getCmtOrderManagement()
							.getCmtOrderStatus().getOrder_value(),
    ...
    private javax.swing.JRadioButton underConstruction;
